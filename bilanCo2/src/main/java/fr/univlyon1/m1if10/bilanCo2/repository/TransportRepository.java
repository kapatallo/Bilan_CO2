...
public interface TransportRepository  extends JpaRepository<Transport, Long> {
    ...
    @Query("SELECT TR FROM Transport TR WHERE TR.annee=:annee AND TR.semaine=:semaine AND TR.id=:id")
    Optional<Transport> findByIdent(@Param("annee") int annee, @Param("semaine") int semaine, @Param("id") int id);
}
